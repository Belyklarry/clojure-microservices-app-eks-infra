...
module "eks_blueprints" {
  ...
  application_teams = {
    clj-microservices = {
      ...
      ## Manifests Example: we can specify a directory with kubernetes manifests that can be automatically applied in the clj-microservices namespace.
      manifests_dir = "./kubernetes/clj-microservices"
